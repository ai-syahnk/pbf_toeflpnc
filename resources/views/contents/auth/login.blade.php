    ...
    <div class="auth-wrapper">
        ...
        <div class="auth-form-container">
            <div class="auth-form-content">
                ...
                <p class="auth-subtitle">Selamat datang kembali di TOEFL PNC.<br> Silakan masuk ke akun Anda untuk mendaftar tes TOEFL.</p>
                ...
                <form action="#" method="POST">
                    ...
                    <div class="text-center mt-4">
                        <p class="small text-muted">Belum memiliki Akun? <a href="#" class="text-primary text-decoration-none fw-bold">Daftar</a></p>
                    </div>
                </form>
            </div>
        </div>
